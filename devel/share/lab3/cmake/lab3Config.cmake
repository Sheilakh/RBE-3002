...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jwwennersten/RBE-3002/src/lab3/${idir}'.  Ask the maintainer 'jwwennersten <jwwennersten@todo.todo>' to fix it.")
    endif()
